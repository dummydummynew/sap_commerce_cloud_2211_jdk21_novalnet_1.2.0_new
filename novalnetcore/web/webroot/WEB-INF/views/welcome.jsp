...
<html lang="en">
<head>
    <title>Welcome to novalnetcore</title>
    <link rel="stylesheet" href="<c:url value="/static/novalnetcore-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "novalnetcore" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/novalnetcore-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/novalnetcore-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/novalnetcore-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/novalnetcore-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/novalnetcore-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
